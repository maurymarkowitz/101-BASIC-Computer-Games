...
720 DATA NOPE,YUP,COMPUTERS ARE SOPHISTICATED MACHINES.  USE APPROPRIATE LANGUAGES
730 LET K9=5
...
1660      LET Y=FNA(M$(1),200,2,1.,1)   'STRAIGHT G, 200 MAX., 1 MILE LONG
...
1970      LET H=T(Z)                    'NEW LEADING TIME AND DRIVER
1980      LET N=F2*(Z+1)+Z
1990 NEXT Z
...
3730 LET R4=0
3740 IF U<O9-U THEN 3430                'ARE WE DONE?
3750 LET U=0                            'YES!
